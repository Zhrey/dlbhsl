    ...
    <#include "common/menu.ftl">
        ...
        <div class="market_right">
            <p style="margin-top: 10px;font-size: 16px">
                <strong>辐射范围：<br></strong>&nbsp;&nbsp;&nbsp;&nbsp;客户遍及辽宁，
                山东荣成，青岛，河北沧州，辛集，江苏连云港等主要对虾养殖区养殖基地。
            </p>
            <div style="width: 800px;height: 650px;margin-top: 12px;">
                <div style="position: absolute;color: white;font-size: 26px;width:800px">
                    ...
                    <div style="height:90px;bottom:300px;width:50%;background:rgba(0,0,0,0.5);position: absolute;left: 50%;;margin: auto;">
                        <p style="text-align:center !important; margin-top:5%;">山东青岛</p>
                    </div>
                    <div style="height:90px;bottom:0;width:50%;background:rgba(0,0,0,0.5);position: absolute;left: 0%;margin: auto;">
                        <p style="text-align:center !important; margin-top:5%;">河北沧州</p>
                    </div>
                    <div style="height:90px;bottom:0;width:50%;background:rgba(0,0,0,0.5);position: absolute;left: 50%;margin: auto;">
